...
export const Footer: React.FC<FooterProps> = ({ onNavigate }) => {
    return (
        <footer className="w-full mt-12 py-6 border-t border-gray-700/50 text-center text-gray-400 text-sm">
            <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-center items-center gap-x-6 gap-y-2">
            ...
            <p className="mt-4">&copy; {new Date().getFullYear()} StoryForge AI. جميع الحقوق محفوظة.</p>
        </footer>
    );
};